...
public class House extends Building {
    ...
    public static House fromCSV(String csv) {
        ...
        House h = new House(parts[1], parts[2], Double.parseDouble(parts[3]), Integer.parseInt(parts[4]), Boolean.parseBoolean(parts[5]));
        h.setId(Integer.parseInt(parts[0]));
        return h;
    }
    public int getNumberOfRooms()          { return numberOfRooms; }
    public void setNumberOfRooms(int n)    { this.numberOfRooms = n; }
    public boolean isHasGarden()           { return hasGarden; }
    public void setHasGarden(boolean val)  { this.hasGarden = val; }
}
